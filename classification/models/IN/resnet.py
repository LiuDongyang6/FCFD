...
def resnet18IN(pretrained=False, progress=True, **kwargs):
...
def resnet34IN(pretrained=False, progress=True, **kwargs):
...
def resnet50IN(pretrained=False, progress=True, **kwargs):
